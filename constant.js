...
export const LOCATION_API = `${import.meta.env.VITE_BASEURL_DESKTOP}/misc/place-autocomplete?input=`
export const LATandLONG_API = `${import.meta.env.VITE_BASEURL_DESKTOP}/misc/address-recommend?place_id=`